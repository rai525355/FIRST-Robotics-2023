...
public class AutoStarting6Group extends SequentialCommandGroup {
  /** Creates a new AutoStarting1Group. */
  public AutoStarting6Group(DrivetrainSubsystem drivetrain, ConeIntake cone, CubeIntake cube) {
    // Add your commands in the addCommands() call, e.g.
    // addCommands(new FooCommand(), new BarCommand());
    addCommands(new CubeShooterMid(cone, cube));
    addCommands(new AutoStarting6Command(drivetrain));
  }
}
